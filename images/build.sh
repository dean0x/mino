...
test_base() {
    ...
    check_dir "mino-base" "/opt/mino-tools"
    check_tool "mino-base" "rg" "/opt/mino-tools/rg --version"
    check_tool "mino-base" "fd" "/opt/mino-tools/fd --version"
    check_tool "mino-base" "bat" "/opt/mino-tools/bat --version"
    check_tool "mino-base" "fzf" "/opt/mino-tools/fzf --version"
    check_tool "mino-base" "delta" "/opt/mino-tools/delta --version"
    check_tool "mino-base" "zoxide" "/opt/mino-tools/zoxide --version"
    check_tool "mino-base" "gh" "/opt/mino-tools/gh --version"
    check_tool "mino-base" "nvim" "/opt/mino-tools/nvim --version"
    check_tool "mino-base" "yq" "/opt/mino-tools/yq --version"
    check_tool "mino-base" "sd" "/opt/mino-tools/sd --version"
    check_tool "mino-base" "eza" "/opt/mino-tools/eza --version"
    check_tool "mino-base" "tokei" "/opt/mino-tools/tokei --version"

    echo ""
    log_info "CLI tools resolve via PATH:"
    ...
    echo ""
    log_info "Runtime (nvm Node.js):"
    check_path_exists "mino-base" "/home/developer/.nvm/versions" "nvm node versions"
